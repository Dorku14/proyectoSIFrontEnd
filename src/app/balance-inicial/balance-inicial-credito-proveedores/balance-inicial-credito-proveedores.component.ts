...
import { BalanceInicialDetalleCreditoProveedoresComponent } from '../balance-inicial-credito-proveedores/balance-inicial-detalle-credito-proveedores/balance-inicial-detalle-credito-proveedores.component';
import { ConsultasBaseComponent } from '../../consultas-base/consultas-base.component';
import { DatePipe } from "@angular/common";

@Component({
  selector: 'app-balance-inicial-credito-proveedores',
  templateUrl: '../../consultas-base/consultas-base.component.html',
  styleUrls: ['../../consultas-base/consultas-base.component.scss']
})
export class BalanceInicialCreditoProveedoresComponent extends ConsultasBaseComponent implements OnInit {
  ...
  constructor(public peticiones: PeticionesWebComponent,
    ...
    private datePipe: DatePipe) {
      ...
      this.Nombrecatalogo = 'Credito Proveedores' 
     }
 ...
 */
   consulta() {
    this.mostrarCargado();
    this.peticiones.peticionPost({}, 'consultaCPMovIni').then((resultado: any) => {
      (resultado);
  ...
  */
  configuraDataGrid(): void {
    let configGrid = {
      columns: 6,
      header: ['#', 'Folio','Proveedor','Importe', 'IVA', 'Total'],
      field: ['NUM', 'FOLIO', 'NOMBRE', 'IMPORTE', 'IVA', 'TOTAL'],
 ...
 */
  ...
  */
  ventanaDetalle(Modo) {
    ...
    const dialogRef = this.dialog.open(BalanceInicialDetalleCreditoProveedoresComponent
      , {
      disableClose: true,
      width: width,
      height: height,
