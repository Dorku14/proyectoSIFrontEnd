...
@Component({
  ...
  templateUrl: './balance-inicial-credito-clientes.component.html',
  styleUrls: ['./balance-inicial-credito-clientes.component.scss']
})
export class BalanceInicialCreditoClientesComponent implements OnInit {
  ...
  datos = { 'NUM': 0, 'FECHA': '', 'CLIENTE': '', 'FACTURA': '', 'IMPORTE': 0, 'IVA': 0 };
  ...
  agregar() {
    ...
    if (!this.validaCamposVacios()) {
      ...
      this.datos = { 'NUM': 0, 'FECHA': '', 'CLIENTE': '', 'FACTURA': '', 'IMPORTE': 0, 'IVA': 0 }
    }
  }
