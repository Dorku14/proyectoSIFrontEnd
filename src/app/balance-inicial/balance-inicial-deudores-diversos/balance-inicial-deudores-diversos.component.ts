...
@Component({
  selector: 'app-balance-inicial-deudores-diversos',
  templateUrl: './balance-inicial-deudores-diversos.component.html',
  styleUrls: ['./balance-inicial-deudores-diversos.component.scss']
})
export class BalanceInicialDeudoresDiversosComponent implements OnInit {
  ...
  datos = { 'NUM': 0, 'FECHA': '', 'DEUDOR': '', 'FOLIO': '', 'CREDITO': '', 'IMPORTE': 0 };
  ...
  agregar() {
    ...
    if (!this.validaCamposVacios()) {
      ...
      this.datos = { 'NUM': 0, 'FECHA': '', 'DEUDOR': '', 'FOLIO': '', 'CREDITO': '', 'IMPORTE': 0 }
    }
  }
