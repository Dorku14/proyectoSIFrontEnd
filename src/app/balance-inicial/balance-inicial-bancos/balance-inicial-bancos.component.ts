...
import { BalanceInicialDetalleBancosComponent } from '../balance-inicial-bancos/balance-inicial-detalle-bancos/balance-inicial-detalle-bancos.component';
...
export class BalanceInicialBancosComponent extends ConsultasBaseComponent implements OnInit {
 ...
 */
  ...
  */
  ventanaDetalle(Modo) {
    ...
    const dialogRef = this.dialog.open(BalanceInicialDetalleBancosComponent
      , {
      disableClose: true,
      width: width,
      height: height,
