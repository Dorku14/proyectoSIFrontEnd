...
import { DetalleComprasComponent } from './../../app/compras/detalle-compras/detalle-compras.component';
...
export class VentasComponent extends ConsultasBaseComponent implements OnInit {
...
*/
  eliminar() {
    ...
    this.funcGenerales.mensajeConfirmacion('confirm', 'warn', 'Confirmación', '¿Seguro que deseas eliminar el registro \"' + this.itemSeleccionado.DESCRIPCION + "\"?", true);
  }
  ...
  Confirmar() {
    ...
    // this.mostrarCargado();
    // let json: any = {};
    // json.NOMBRE = this.itemSeleccionado.DESCRIPCION;
    // this.peticiones.peticionPost(json, 'eliminarVentas').then((resultado: any) => {
